...
`{% raw %}{{ site.url }}{{ site.baseurl }}/assets/images/ScraperKnowledgeBase.png{% endraw %}`

`{% raw %}{{ site.url }}{{ site.baseurl }}/assets/images/ScraperKnowledgeBaseCondensed.png{% endraw %}`
